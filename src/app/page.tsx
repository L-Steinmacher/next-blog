...
export const metadata: Metadata = {
    ...
    robots: 'index,follow',
    keywords:
        'Lucas Steinmacher, Panz, Panzer, Software Developer, Software Engineer',
};
                    ...
                    <div className="flex flex-col items-center justify-between sm:flex-row">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="pt-4 text-lg">
                                Hey there! Names Lucas, a.k.a. Panz. I am a
                                software engineer based in the Greater Seattle
                                area. <br />
                                I&apos;m excited about{' '}
                                <a
                                ...
                                <br />I also write about whatever is on my mind
                                from time to time.
                            </p>
                            <Link
                    ...
                    <div className="flex flex-col items-start w-full mx-auto">
                        <div className="flex flex-col py-8">
                            <p className="text-xl text-justify">
                                I write sometimes about things I am working on,
                                and things I am learning. Here&apos;s the
                                latest:
                            </p>
